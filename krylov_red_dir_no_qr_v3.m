function [Vr,Wr] = krylov_red_dir_no_qr_v3(AA,BB,CC,EE,S2,Br,Cr)
%Function krylov_red_dir is created by S. Gugercin.
%This function is modified by Yiding Lin. The final orthogolization stage is placed outside.
