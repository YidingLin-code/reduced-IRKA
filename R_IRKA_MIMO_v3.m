function [iter_number,error_shifts,new_shifts,new_Br,new_Cr,Vr,Wr,inner_its_vector]=R_IRKA_MIMO_v3(A,B,C,E,r,outer_tol,inner_tol)
...
%This is the main function of R-IRKA.
...
for jj=1:30
    ...
    [Vr,~] = qr([Vr,Vr_tem],0);%accumulate all of V
    [Wr,~] = qr([Wr,Wr_tem],0);
